...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.UserAssociation", b =>
                {
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.UserPR", b =>
                {
                    b.Property<string>("Username")
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.WorkoutAssignment", b =>
                {
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.UserAssociation", b =>
                {
                    b.HasOne("Lift.Buddy.Core.Database.Entities.User", "Athlete")
                        .WithOne()
                        .HasForeignKey("Lift.Buddy.Core.Database.Entities.UserAssociation", "AthleteUsername")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lift.Buddy.Core.Database.Entities.User", "Trainer")
                        .WithOne()
                        .HasForeignKey("Lift.Buddy.Core.Database.Entities.UserAssociation", "TrainerUsername")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.UserPR", b =>
                {
                    b.HasOne("Lift.Buddy.Core.Database.Entities.User", "User")
                        .WithOne("UserPR")
                        .HasForeignKey("Lift.Buddy.Core.Database.Entities.UserPR", "Username")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lift.Buddy.Core.Database.Entities.WorkoutAssignment", b =>
                {
                    b.HasOne("Lift.Buddy.Core.Database.Entities.WorkoutPlan", "WorkoutSchedule")
