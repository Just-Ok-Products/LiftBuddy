...
namespace Lift.Buddy.Core.Migrations
{
    ...
    [Migration("20230927175750_ColsRenaming")]
    partial class ColsRenaming
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lift.Buddy.Core.DB.Models.UserPersonalRecord", b =>
                {
                    b.Property<string>("Username")
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Lift.Buddy.Core.DB.Models.UserPersonalRecord", b =>
                {
                    b.HasOne("Lift.Buddy.Core.DB.Models.User", "User")
                        .WithOne("UserPersonalRecord")
                        .HasForeignKey("Lift.Buddy.Core.DB.Models.UserPersonalRecord", "Username")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lift.Buddy.Core.DB.Models.User", b =>
                {
                    b.Navigation("UserPersonalRecord")
                        .IsRequired();
